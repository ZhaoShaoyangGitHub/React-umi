            ...
            <View className={styles.MemberInformationMain}>
                ...
                <View className={styles.baseInfo}>
                    <View className={styles.infoListItem}>
                        ...
                        <View className={styles.info_value}>
                            <Text className={styles.info_value}>{nickname}</Text>
                        </View>
                    </View>
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>性别</Text>
                        <View className={styles.info_value}>{gender}</View>
                    </View>
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>生日</Text>
                        <View className={styles.info_value}>{birthday}</View>
                    </View>
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>血型</Text>
                        <View className={styles.info_value}>{bloodType}</View>
                    </View>
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>属相</Text>
                        <View className={styles.info_value}>{chineseZodiac}</View>
                    </View>
                    <View className={`${styles.infoListItem} ${styles.noLine}`}>
                        <Text className={styles.info_title}>星座</Text>
                        <View className={styles.info_value}>{constellation}</View>
                    </View>
                    <View className={styles.whiteSpace} />
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>消费金额（元）</Text>
                        <View className={styles.info_value}>{userConsumeAmount}</View>
                    </View>
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>职业</Text>
                        <View className={styles.info_value}>{job}</View>
                    </View>
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>工作时长</Text>
                        <View className={styles.info_value}>{workingTime}</View>
                    </View>
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>婚姻状态</Text>
                        <View className={styles.info_value}>{marriageStatus}</View>
                    </View>
                    <View className={`${styles.infoListItem} ${styles.noLine}`}>
                        <Text className={styles.info_title}>子女个数</Text>
                        <View className={styles.info_value}>{childNumber}</View>
                    </View>
                    <View className={styles.whiteSpace} />
                </View>
                ...
                <View className={styles.baseInfo}>
                    <View className={styles.infoListItem}>
                        ...
                        <View className={styles.info_value}>{height}</View>
                    </View>
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>体重(kg)</Text>
                        <View className={styles.info_value}>{weight}</View>
                    </View>
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>标准体重(kg)</Text>
                        <View className={styles.info_value}>{standardWeight}</View>
                    </View>
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>目标体重(kg)</Text>
                        <View className={styles.info_value}>{targetWeight}</View>
                    </View>
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>胸围(cm)</Text>
                        <View className={styles.info_value}>{chest}</View>
                    </View>
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>腰围(cm)</Text>
                        <View className={styles.info_value}>{waistline}</View>
                    </View>
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>臀围(cm)</Text>
                        <View className={styles.info_value}>{hipline}</View>
                    </View>
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>上臀围(cm)</Text>
                        <View className={styles.info_value}>{highHip}</View>
                    </View>
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>左腿围(cm)</Text>
                        <View className={styles.info_value}>{leftLeg}</View>
                    </View>
                    <View className={styles.infoListItem}>
                        <Text className={styles.info_title}>右腿围(cm)</Text>
                        <View className={styles.info_value}>{rightLeg}</View>
                    </View>
                    <View className={`${styles.infoListItem} ${styles.noLine}`}>
                        <Text className={styles.info_title}>小腿围(cm)</Text>
                        <View className={styles.info_value}>{shank}</View>
                    </View>
                </View>
                <View className={styles.whiteSpace} />
            </View>
