...
import {ACTIVITYCODE, ACTIVITYCODELIST} from "../active_config";
          ...
          <div className={styles.brandList}>
            ...
            {!loding &&
              ...
              active.list.map((item: any, index: number) => {
                ...
                //test
                // status.momentDays = 20;
                // status.shareCount = 15;
                // status.qualifyType = 1;
                // test -- end
  ...
  return (
    <div className={`${styles.carry} ${!isImgShow && styles.carryMB}`}>
      <span className={styles.yellow}>
        恭喜你！成功解锁了 <b>{item.progressTxt}</b>
      </span>
      <br />
      务必记得3日当天来抽奖哦，过时作废哦●﹏●
      {isImgShow && (
