                ...
                <View className={styles.userinfo}>
                    ...
                    <View className={styles.rightInfo}>
                        ...
                        <View className={styles.infoItem}>
                            ...
                            <View className={styles.val}>{itemInfo.weight || 0}kg</View>
                        </View>
                    </View>
                </View>
                                ...
                                <View key={item.id} className={styles.packageBox}>
                                    ...
                                    <View className={styles.botBox}>
                                        ...
                                        <View className={styles.right}>
                                            <View
                                                className={`${styles.desBtn} ${val === 0 ? styles.disable : ''}`}
                                            ...
                                            <View
                                                className={`${styles.addBtn} ${
                                                    val === item.remainingNumber ? styles.disable : ''
                                                }`}
